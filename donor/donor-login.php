...
if(isset($_POST['sub']))
{
    ...
    $q=$db->prepare("SELECT * FROM donor_registration WHERE uname='$un' AND pass='$ps'");
    $q->execute();
...
<body>
    ...
    Does not have an account ? <a href="donor-red.php">Click here to register</a>
-->
    ...
    <?php
         if($flag == "ok"){
            echo "<div><div class='alert alert-danger'  role='alert' style='margin-top: 5px'>
                    ...
                    <form method="post">
                        <div class="form-body">
                            ...
                            <div class="in">
                                ...
                                <input type="password" name="ps" required id="password" placeholder="Password" class="in-sty">
                            </div>
