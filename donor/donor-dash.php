                ...
                <div class="row">
                    <div class="col">
                        <div class="card-border">
                            ...
                            <div class="val">
                                <h6>Total Donation Request</h6>
                                <?php
                            $q=$db->prepare("SELECT * FROM donor WHERE uname=:uname");
                    ...
                    <div class="col">
                        <div class="card-border">
                            ...
                            <div class="val">
                                ...
                                <?php
                                $pending="Pending";
                            $q=$db->prepare("SELECT * FROM donor WHERE uname=:uname AND status=:pending");
                            $q->bindValue('uname',$un);
                    ...
                    <div class="col">
                        <div class="card-border">
                            ...
                            <div class="val">
                                ...
                                <?php
                            $approved ="Approved";
                            $q=$db->prepare("SELECT * FROM donor WHERE uname=:uname AND status=:approved");
                            $q->bindValue('uname',$un);
                    ...
                    <div class="col">
                        <div class="card-border">
                            ...
                            <div class="val">
                                ...
                                <?php
                            $rejected ="Rejected";
                            $q=$db->prepare("SELECT * FROM donor WHERE uname=:uname AND status=:rejected");
                            $q->bindValue('uname',$un);
