...
{   
    $uname=$_POST['un']; 
    $q=$db->query("SELECT * FROM donor_registration WHERE uname='$uname'");
    ...
    if($rl)
    {
        $flag = "already";
            ...
            // echo "<script>alert('not_ok');</script>";
        ...
        $q=$db->prepare("INSERT INTO donor_registration (uname,pass,name,address,age,height,weight,disease,gender,bgroup,mno,profile_pic,ID) VALUES (:uname,:pass,:name,:add,:age,:ht,:wt,:dise,:gender,:bgroup,:mob,:img_des1,:img_des2)");
...
<body>
   ...
   if($flag == "ok"){
    ...
    margin-bottom: 0px; '>
    Donor Registration is <strong>Successful!</strong>
    </div>";
    }
    else if ($flag == "not_ok") {
        echo "<div class='alert alert-danger'  role='alert' style='margin-top: 50px;
    margin-bottom: 0px; '>
    Donor Registration is <strong>fail!</strong>
    </div>";
    }
    ...
    <div class="back-color">
        <div class="conten">
            <div class="card-cont">
                ...
                <div class="card-body" style="height: 1510px">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        <div class="form-body">
                            ...
                            <div class="in">
                                ...
                                <input type="text" name="un" required id="username" autofocus placeholder="Username"
                                    class="in-sty">
                            </div>
                            <div class="in">
                            ...
                            <select class="form-select form-select-sm" aria-label=".form-select-sm example" style="width: 168px; display: inline; margin-left: 50px;"  name="bgroup" required>
                              ...
                              <div class="in" style="margin-left: 67px;">
                                ...
                                <input type="text" required name="age" autofocus placeholder="age"
                                    class="in-sty">
                            </div>

                            <div class="in" style="margin-left: 46px;">
                                <label for="height" style="font-size: 18px">Height</label>
                                <input type="text" required name="ht" autofocus placeholder="Height in inches"
                                    class="in-sty">
                            </div>
                            <div class="in" style="margin-left: 46px;">
                                <label for="weight" style="font-size: 18px">Weight</label>
                                <input type="text" required name="wt" autofocus placeholder="Weight in kg"
                                    class="in-sty">
                            </div>

                            <div class="in" style="margin-left: -19px;">
                                <label for="disease" style="font-size: 18px">Disease(if any)</label>
                                <input type="text" required name="dise" autofocus placeholder="Disease"
                                    class="in-sty" value="Nothing">
                            </div>


                            <div class="form-floating">
                            <textarea class="form-control" placeholder="Enter Address here" id="floatingTextarea" name="add" required></textarea>
                             <label for="floatingTextarea">Address</label>
                            </div>

                            <div class="in" style="margin-left: -19px;">
                                <label for="mobile number" style="font-size: 18px;">Mobile Number</label>
                                <input type="text" required name="mob" autofocus placeholder="Number"
                                    class="in-sty">
                            </div>
                ...
                height: 26px; margin-top: 22px;">
                  ...
                  height: 47px;">
                    ...
                    <div style="margin-top: -13px; margin-left: 88px;">
                        Already have an account ? <a href="donor-login.php">Click here to login</a>
                    </div>
                </div>
            </div>
        </div>
