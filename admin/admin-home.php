            ...
            <div class="row">
                    <div class="col">
                        <div class="card-border">
                            ...
                            <?php echo "Total Donors<br>";
                            $bgroup="A+";

                            $q=$db->query("SELECT * FROM donor_registration WHERE 1");
                            echo $row=$q->rowcount();
                    ...
                    <div class="col">
                        ...
                        <div style=" padding-right: 19px; padding-bottom: 46px;  padding-top: 13px;">
                            ...
                            <div class="val" style="margin-top: 0px;">
                            <?php echo "Total Requests<br>";
                            $bgroup="B+";

                            $q=$db->query("SELECT * FROM blood_request WHERE 1");
                            echo $row=$q->rowcount();
                    ...
                    <div class="col">
                        ...
                        <div style=" padding-right: 19px; padding-bottom: 46px;  padding-top: 13px;">
                            ...
                            <div class="val" style="margin-top: 0px;">
                            <?php echo "Approved Requests<br>";
                            $bgroup="AB+";

                            $q=$db->query("SELECT * FROM blood_request WHERE status='Approved'");
                            echo $re = $row=$q->rowcount();
                    ...
                    <div class="col">
                        ...
                        <div style=" padding-right: 19px; padding-bottom: 46px;  padding-top: 13px;">
                            ...
                            <div class="val" style="margin-top: 0px;">
                            <?php echo "Total Blood Unit<br>";
                            $bgroup="O+";

                            $q=$db->prepare("SELECT SUM(stock) AS total FROM blood_stock WHERE 1");
                            $q->execute();
