...
{   if(isset($_POST['edit'])){
    ...
    //    echo "</pre>";
        ...
        $q=$db->prepare("UPDATE `patient_registration` SET `uname`=:uname,`pass`=:pass,`name`=:name,`gender`=:gender,`bgroup`=:gender,`age`=:age,`disease`=:dise,`doctor_name`=:doc,`address`=:add,`mno`=:mob,`profile_pic`=:img_des1,`ID`=:img_des2 WHERE sno=:id");
        $q->bindValue('uname',$uname);
        $q->bindValue('pass',$pass);
        $q->bindValue('name',$name);
        $q->bindValue('gender',$gender);
        $q->bindValue('gender',$bgroup);
        $q->bindValue('age',$age);
    ...
    <div class="back-color">
        <div class="conten">
            <div class="card-cont">
               ...
               $q=$db->query("SELECT * FROM patient_registration WHERE sno=$id");
                    ...
                    <form method="post" enctype="multipart/form-data" >
                        <div class="form-body">
                            ...
                            <div class="in">
                                ...
                                <input type="text" name="un" required id="username" placeholder="Username"
                            ...
                            <select class="form-select form-select-sm" aria-label=".form-select-sm example" required style="width: 168px; display: inline; margin-left: 50px;"  name="bgroup">
                            ...
                            <div class="in" style="margin-left: 27px;">
                                ...
                                <input type="text" name="dise" required value="<?=$rl->disease?>"  placeholder="Disease"
                                class="in-sty" >
                            </div>
                            ...
                            <div class="in" style="margin-left: -15px;">
                                ...
                                <input type="text" name="doc" required value="<?=$rl->doctor_name?>"  placeholder="Doctor Name"
                                    class="in-sty">
                            </div>
