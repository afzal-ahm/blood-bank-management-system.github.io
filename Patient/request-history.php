...
<body>
    ...
    margin-top: 50px;">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
          <a href="patient-dash.php" class="nav-link text-white" aria-current="page">
            <i class="fas fa-home">
        ...
        <li>
          <a href="request-history.php" class="nav-link active">
            ...
            <tbody>
              <tr>
                ...
                <?php
                 ...
                 {echo "<div style='color: white; background-color: blue;
                  '><h6>Pending</h6></div>";
                }
